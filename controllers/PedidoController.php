...
class PedidoController {
    ...
    public static function crear(Router $router) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(!empty($_FILES['imagen_instrucciones']['tmp_name'])) {
                ...
                $imagen_png_adicional = Image::make($_FILES['imagen_instrucciones']['tmp_name'])->fit(800,800)->encode('png',80);
                $imagen_webp_adicional = Image::make($_FILES['imagen_instrucciones']['tmp_name'])->fit(800,800)->encode('webp',80);
            ...
            if(empty($alertas)) {
                ...
                if($_FILES['imagen']) {
                    ...
                    if($_FILES['imagen_instrucciones']) {
                        if($_POST['imagen_adicional']) {
