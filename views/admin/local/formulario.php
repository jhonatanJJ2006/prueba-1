...
<fieldset class="formulario-admin__fieldset">
    ...
    <div class="formulario-admin__campo">
        <label class="formulario-admin__label" for="imagen_instrucciones">Imagen Adicional</label>
        <input class="formulario-admin__input formulario-admin__input--file" id="imagen_instrucciones" type="file" name="imagen_instrucciones">
    </div>
    ...
    <div class="formulario-admin__campo">
        <label class="formulario-admin__label" for="tamaño">Tamaño</label>
        <input class="formulario-admin__input" id="tamaño" type="text" placeholder="Tamaño Pastel" name="tamaño" value="<?php echo $pedido->tamaño ?? '' ?>">
    </div>
